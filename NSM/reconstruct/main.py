...
# The .latent_fit and .wandb_logging imports re-serve the §8.0.C split's moved
# definitions. Public API, not scaffolding: ``NSM.reconstruct`` (star-import of this
# module) and ``NSM.reconstruct.main`` are both live import paths, so every name that
# lived here stays importable from both. Frozen by
